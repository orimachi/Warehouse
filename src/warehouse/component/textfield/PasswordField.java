...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/warehouse/icon/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/warehouse/icon/eye_hide.png")).getImage();
