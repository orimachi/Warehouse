...
public class MessageDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        background1 = new warehouse.component.notification.Background();
        cmdCancel = new warehouse.component.notification.ButtonCustom();
        cmdOK = new warehouse.component.notification.ButtonCustom();
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/warehouse/icon/icon.png"))); // NOI18N
    ...
    private warehouse.component.notification.Background background1;
    private warehouse.component.notification.ButtonCustom cmdCancel;
    private warehouse.component.notification.ButtonCustom cmdOK;
