 ...
 * @author PC
 */
public class WarehouseJFrame extends javax.swing.JFrame {

    /**
     * Creates new form WarehouseJFrame
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarehouseJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WarehouseJFrame().setVisible(true);
            }
        });
    }
