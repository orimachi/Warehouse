 ...
 * @author PC
 */
public class StockInJFrame extends javax.swing.JFrame {
...
//        stock.setUsername(currentUser.getUsername());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StockInJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StockInJFrame().setVisible(true);
            }
        });
    }
